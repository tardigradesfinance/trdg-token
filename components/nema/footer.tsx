...
export function NemaFooter() {
  ...
  return (
    <footer className="relative py-12 mt-12">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-px bg-gradient-to-r from-transparent via-green-500/30 to-transparent"></div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-6 sm:mb-8">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-8 h-8 sm:w-10 sm:h-10 bg-green-900/30 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-green-800/50 transition-colors"
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-10">
            <div className="relative inline-block w-full sm:w-auto">
              ...
              <Button
                className="relative bg-gradient-to-r from-green-600 to-teal-500 hover:from-green-700 hover:to-teal-600 flex items-center gap-2 w-full sm:w-auto"
                onClick={() =>
                  window.open(
            ...
            <div className="relative inline-block w-full sm:w-auto">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-teal-600 to-emerald-500 rounded-lg opacity-75 blur-sm animate-pulse"></div>
              <Button
                className="relative bg-gradient-to-r from-teal-600 to-emerald-500 hover:from-teal-700 hover:to-emerald-600 flex items-center gap-2 w-full sm:w-auto"
          ...
          <div className="bg-green-900/20 backdrop-blur-sm border border-green-500/20 rounded-lg p-3 sm:p-4 max-w-2xl mx-auto mb-6 sm:mb-8">
          ...
          <div className="flex items-center justify-center">
            ...
            <button
              onClick={scrollToTop}
              className="ml-4 sm:ml-6 w-8 h-8 sm:w-10 sm:h-10 bg-green-500/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-green-500/40 transition-colors"
            >
