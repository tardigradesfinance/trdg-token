...
export function BioScanner() {
    ...
    return (
        <section id="bioscanner" className="relative py-24 md:py-32 bg-black overflow-hidden">
            <GridBackground />
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="text-center mb-16">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-trdg-green/10 border border-trdg-green/20 mb-6"
                    >
                        <Activity className="text-trdg-green animate-pulse" size={16} />
                        <span className="text-[10px] font-mono text-trdg-green uppercase tracking-widest font-black">
                ...
                <div className="flex justify-center gap-4 mb-12">
                    <button
                        ...
                        className={`px-8 py-4 rounded-xl font-orbitron font-bold uppercase text-sm transition-all ${activeChain === 'bsc'
                    ...
                    <button
                        ...
                        className={`px-8 py-4 rounded-xl font-orbitron font-bold uppercase text-sm transition-all ${activeChain === 'eth'
                    ...
                    <button
                        ...
                        className="p-4 rounded-xl bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:border-white/30 transition-all"
                        title="Refresh Data"
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                    ...
                    <motion.div
                        layout
                        className="p-8 rounded-3xl bg-zinc-900/50 border border-white/10 relative overflow-hidden"
                    >
                        <div className="absolute top-4 right-4 font-mono text-[8px] text-gray-700">PRICE_FEED.EXE</div>
                        <div className="flex items-center gap-4 mb-6">
                            <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${activeChain === 'bsc' ? 'bg-yellow-500/10 text-yellow-500' : 'bg-blue-500/10 text-blue-400'}`}>
                                <TrendingUp size={24} />
                            </div>
                            <div>
                                <h3 className="font-orbitron font-bold text-white uppercase text-lg">$TRDG Price</h3>
                                <p className="text-[10px] text-gray-500 font-mono uppercase">{activeChain.toUpperCase()} Network</p>
                            </div>
                        </div>

                        <div className="space-y-4">
                            <div>
                                <div className="text-xs font-mono text-gray-500 uppercase mb-1">Price_Per_Token</div>
                                <div className="text-2xl font-bold text-white font-mono">
                                    {loading ? '...' : `$${currentStats?.price.toFixed(18) || '0'}`}
                                </div>
                            </div>
                            <div className="p-4 bg-black/40 rounded-xl border border-white/5">
                                <div className="text-xs font-mono text-gray-500 uppercase mb-1">Price_Per_Trillion</div>
                                <div className={`text-3xl font-black font-orbitron ${activeChain === 'bsc' ? 'text-yellow-400' : 'text-blue-400'}`}>
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h3 className="font-orbitron font-bold text-white uppercase text-lg">Tun State (Burned)</h3>
                                <p className="text-[10px] text-gray-500 font-mono uppercase">Tokens in Cryptobiosis</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-black/40 rounded-xl border border-white/5">
                                <div className="text-xs font-mono text-gray-500 uppercase mb-1">Burned_Tokens</div>
                                <div className="text-xl font-bold text-orange-400 font-mono">
                                    {loading ? '...' : formatNumber(currentStats?.burned || 0)}
                                </div>
                            </div>
                            <div className="text-[10px] text-gray-400 font-mono">
                                Initial: 50% Launch Burn | LP Tokens: LOCKED FOREVER
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h3 className="font-orbitron font-bold text-white uppercase text-lg">Colony Metrics</h3>
                                <p className="text-[10px] text-gray-500 font-mono uppercase">Cap & Liquidity</p>
                            </div>
                        </div>

                        <div className="space-y-4">
                            <div className="p-4 bg-black/40 rounded-xl border border-white/5">
                                <div className="text-xs font-mono text-gray-500 uppercase mb-1">Market_Cap</div>
                                <div className="text-2xl font-bold text-trdg-cyan font-orbitron">
                                    {loading ? '...' : formatCurrency(currentStats?.marketCap || 0, 0)}
                                </div>
                            </div>
                            <div className="p-4 bg-black/40 rounded-xl border border-white/5">
                                <div className="text-xs font-mono text-gray-500 uppercase mb-1">Liquidity_Pool</div>
                                <div className="text-xl font-bold text-trdg-green font-mono">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    >
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                <h3 className="text-xl font-orbitron font-bold text-white uppercase">Wallet Scanner</h3>
                                <p className="text-[10px] font-mono text-gray-500 uppercase tracking-widest">
                                    Input your {activeChain.toUpperCase()} wallet for diagnostics
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div className="flex gap-2">
                                <input
                                    ...
                                    placeholder="0x..."
                                    className="flex-1 bg-black/50 border border-white/10 rounded-xl px-4 py-3 font-mono text-sm text-white placeholder:text-gray-600 focus:outline-none focus:border-purple-500/50"
                                />
                                <button
                                    onClick={fetchWalletData}
                                    disabled={walletLoading || walletAddress.length !== 42}
                                    className="px-6 py-3 rounded-xl bg-purple-500 text-white font-bold font-orbitron uppercase text-xs disabled:opacity-50 disabled:cursor-not-allowed hover:bg-purple-400 transition-colors"
                                >
                                    ...
                                    >
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="p-4 bg-black/40 rounded-xl border border-white/5">
                                                ...
                                                <div className="text-lg font-bold text-white">{formatNumber(walletData.balance)}</div>
                                                <div className="text-xs text-gray-400">{formatCurrency(walletData.value, 4)}</div>
                                            </div>
                                            <div className="p-4 bg-black/40 rounded-xl border border-purple-500/20">
                                                ...
                                                <div className="text-lg font-bold text-purple-400">{formatNumber(walletData.rewards)}</div>
                                                <div className="text-xs text-gray-400">{formatCurrency(walletData.rewardsValue, 4)}</div>
                                            </div>
                                        </div>
                                        <p className="text-[10px] text-gray-500 font-mono text-center">
                                            Note: Full rewards require transaction history analysis
                                        </p>
                                    </motion.div>
                                )}
                            </AnimatePresence>
                    ...
                    >
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                <h3 className="text-xl font-orbitron font-bold text-white uppercase">Projection Terminal</h3>
                                <p className="text-[10px] font-mono text-gray-500 uppercase tracking-widest">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 font-mono text-white focus:outline-none focus:border-trdg-cyan/50"
                                />
                            </div>
                            <div>
                            ...
                            <div className="p-6 rounded-2xl bg-black/60 border border-trdg-cyan/20 text-center">
                                <div className="text-xs font-mono text-gray-500 uppercase mb-2">Projected Value</div>
                                <motion.div
                                    key={projection}
                                    initial={{ scale: 0.9, opacity: 0 }}
                                    animate={{ scale: 1, opacity: 1 }}
                                    className="text-4xl font-black font-orbitron text-trdg-green text-glow-green"
                                >
                                    {isNaN(projection) ? '$0' : formatCurrency(projection, 2)}
                                </motion.div>
                                <div className="text-xs font-mono text-gray-400 mt-2">
                                    {(targetMC / currentMC).toFixed(1)}x from current MC
                                </div>
                            </div>
                        </div>
                    </motion.div>
                ...
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    className="mt-12 p-6 rounded-2xl bg-gradient-to-r from-trdg-cyan/5 via-black to-trdg-green/5 border border-white/5 text-center"
                >
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                        <div>
                            <div className="text-[10px] font-mono text-gray-500 uppercase mb-1">Initial Supply</div>
                            <div className="text-sm font-bold text-white">100 Quadrillion</div>
                        </div>
                        <div>
                            <div className="text-[10px] font-mono text-gray-500 uppercase mb-1">Launch Burn</div>
                            <div className="text-sm font-bold text-orange-400">50% (Same Both Chains)</div>
                        </div>
                        <div>
                            <div className="text-[10px] font-mono text-gray-500 uppercase mb-1">LP Status</div>
                            <div className="text-sm font-bold text-trdg-green">🔥 BURNED FOR ETERNITY 🔥</div>
                        </div>
                        <div>
                            <div className="text-[10px] font-mono text-gray-500 uppercase mb-1">Contract (Both Chains)</div>
                            <div className="text-[10px] font-mono text-trdg-cyan break-all">{TRDG_ADDRESS}</div>
                        </div>
                    </div>
                    {lastRefresh && (
